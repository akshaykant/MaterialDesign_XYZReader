...
public class ArticleListAdapter extends CursorRecyclerViewAdapter<ArticleListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final Cursor cursor) {
        ...
        viewHolder.authorView.setText(cursor.getString(ArticleLoader.Query.AUTHOR));

        viewHolder.thumbnailView.setAspectRatio(cursor.getFloat(ArticleLoader.Query.ASPECT_RATIO));

        Glide.clear(viewHolder.thumbnailView);
